...
class TabletsSplitMergeTest(LongevityTest):
    ...
    def test_tombstone_gc(self):  # pylint: disable=too-many-locals  # noqa: PLR0914

        # (1) initiate schema.
        InfoEvent(message="Create a keyspace with tablets initial value").publish()
    ...
    def _wait_for_tablets_merge(self, timeout_min: int = 15):
        ...
        """
        text = "Waiting for a smaller tablets number"
