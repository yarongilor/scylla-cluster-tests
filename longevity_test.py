...
class LongevityTest(ClusterTester, loader_utils.LoaderUtilsMixin):
    ...
    def test_custom_time(self):
        ...
        if self.partitions_attrs and self.partitions_attrs.validate_partitions:
            ...
            self.partitions_attrs.partitions_dict_before = self.collect_partitions_info(ignore_limit_rows_number=True)
        ...
        if self.partitions_attrs and self.partitions_attrs.validate_partitions:
            self.validate_rows_per_partitions(ignore_limit_rows_number=True)
