...
class TombstoneGcStandardMonkey(Nemesis):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.disrupt_methods_list = (
            list(filter(lambda method: method != 'disrupt_modify_table_gc_mode', tombstone_gc_mode_list)))
...
class TombstoneGcAdvancedMonkey(Nemesis):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.log.debug('tombstone_gc_mode_list: %s', tombstone_gc_mode_list)  #TODO: DBG
        self.disrupt_methods_list = (
