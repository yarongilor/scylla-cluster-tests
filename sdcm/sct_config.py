...
class SCTConfiguration(dict):
    ...
    config_options = [
        ...
        dict(name="exclude_disabled_nemesis", env="SCT_EXCLUDE_DISABLED_NEMESIS",
             type=boolean,
             help="""exclude_disabled_nemesis determines whether 'disabled' nemeses are filtered out from list
