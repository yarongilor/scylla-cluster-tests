...
# ---------------------------------------------------------------------------
class _FakeKmsParams(dict):
    """Minimal params stand-in for prepare_kms_host: dict access plus a few attributes."""
...
def _make_kms_tester_self(**param_overrides):
    ...
    return types.SimpleNamespace(
        params=params,
        test_config=types.SimpleNamespace(test_id=lambda: "test-id-123"),
        log=logging.getLogger("test_prepare_kms_host"),
    )
